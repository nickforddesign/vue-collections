...
var empty$1 = /*#__PURE__*/_curry1_1(function empty(x) {
  return x != null && typeof x['fantasy-land/empty'] === 'function' ? x['fantasy-land/empty']() : x != null && x.constructor != null && typeof x.constructor['fantasy-land/empty'] === 'function' ? x.constructor['fantasy-land/empty']() : x != null && typeof x.empty === 'function' ? x.empty() : x != null && x.constructor != null && typeof x.constructor.empty === 'function' ? x.constructor.empty() : _isArray$2(x) ? [] : _isString_1(x) ? '' : _isObject_1(x) ? {} : _isArguments_1(x) ? function () {
    return arguments;
  }() :
  // else
  void 0;
...
var insertModel = function () {
  ...
  return function insertModel(_x) {
...
var insertModels = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(vm) {
  ...
  return function insertModels(_x3) {
...
var deleteModel = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(vm, id) {
    var index;
    return regenerator.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            index = vm.models.findIndex(function (model) {
              return model[vm.id_attribute] === id;
            });
...
function translateModel(vm, data) {
  var Model = vm.Model;
  return Model
  // ? new Model(data).$data
...
function validateModels(models) {
  ...
  if (models) {
    if (!(models instanceof Array)) {
      throw new TypeError('Collection expected models as an array, received ' + (typeof models === 'undefined' ? 'undefined' : _typeof(models)));
    }
  }
  return valid;
}
  ...
  function Collection(_ref) {
    ...
    return new Vue({
      ...
      computed: {
        ...
        id_attribute: function id_attribute() {
...
export { Collection$1 as Collection };
